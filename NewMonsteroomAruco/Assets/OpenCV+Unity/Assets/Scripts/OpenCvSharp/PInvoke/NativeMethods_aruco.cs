...
namespace OpenCvSharp
{
    static partial class NativeMethods
    {
        ...
        public static extern void aruco_estimatePoseSingleMarkers([MarshalAs(UnmanagedType.LPArray)] IntPtr[] corners, int cornerSize1, int[] contoursSize2,
                                         float markerLength,
                                         IntPtr cameraMatrix, IntPtr distCoeffs,
                                         IntPtr rvecs, IntPtr tvecs, IntPtr objPoints);

        [DllImport(DllExtern, CallingConvention = CallingConvention.Cdecl)]
        public static extern void aruco_estimatePoseSingleMarkers_md([MarshalAs(UnmanagedType.LPArray)] IntPtr[] corners, int cornerID, int cornerLen,
                                         float markerLength,
                                         float[] cameraMatrix, IntPtr distCoeffs,
                                         float[] rtInfo);
        
        [DllImport(DllExtern, CallingConvention = CallingConvention.Cdecl)]
        public static extern void aruco_estimatePoseSingleMarkers_all([MarshalAs(UnmanagedType.LPArray)] IntPtr[] corners, int cornerSize1, int[] contoursSize2,
                                         float markerLength,
                                         float[] cameraMatrix, IntPtr distCoeffs,
                                         [MarshalAs(UnmanagedType.LPArray)] IntPtr[] rtInfo);
